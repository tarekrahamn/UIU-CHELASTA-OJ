    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="info-box">
                ...
                <p>This section provides information about List, including their importance and difficulty level.</p>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="resources">
                ...
                <div class="resource-item">
                    <div class="title"><a href="https://www.youtube.com/watch?v=je7zlYfJf7Q&list=PL1w8k37X_6L9NXrP1D31hDTKcdAPIL0cG&index=7">1. List | C++ STL (Standard Template Library) | std::list Knowledge Center</a></div>
                    <div class="title"><a href="https://www.programiz.com/cpp-programming/list">2. C++ List | Programiz</a></div>
                    ...
                    <div class="title"><a href="https://www.geeksforgeeks.org/list-cpp-stl/">4. List in C++ Standard Template Library (STL) | Geeks for Geeks</a></div>
                </div>
            </div>
        </div>
            ...
            <div class="problems">
                <table class="problem-table">
                    ...
                    <tbody>
                        <tr>
                            <td></td>
                            <td><a href="https://vjudge.net/problem/Aizu-ALDS1_3_C">1. Doubly Linked List
                                </a></td>
