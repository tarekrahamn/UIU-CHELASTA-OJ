    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="info-box">
                ...
                <p>This section provides information about Basic Greedy Algorithms, including their importance and difficulty level.</p>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="resources">
                ...
                <div class="resource-item">
                    <div class="title"><a href="https://usaco.guide/bronze/intro-greedy?lang=cpp">1. Introduction to Greedy Algorithms | USACO Guide</a></div>
                    <div class="title"><a href="https://usaco.guide/silver/greedy-sorting?lang=cpp">2. Greedy Algorithms with Sorting | USACO Guide</a></div>
                </div>
            </div>
        </div>
            ...
            <div class="problems">
                <table class="problem-table">
                    ...
                    <tbody>
                        <tr>
                            <td></td>
                            <td><a href="https://vjudge.net/problem/Gym-102951B">1. Studying Algorithms</a></td>
