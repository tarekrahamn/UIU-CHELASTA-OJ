    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="resources">
                ...
                <div class="resource-item">
                    <div class="title"><a href="https://www.youtube.com/watch?v=Zkr0aAdD1Ww&list=PLzMcBGfZo4-lmGC8VW0iu6qfMHjy7gLQ3&index=9">1. If, Else & Else If | Tech With Tim</a></div>
                    <div class="title"><a href="https://www.programiz.com/cpp-programming/if-else">2. C++ if, if...else and Nested if...else | Programiz</a></div>
                </div>
            </div>
        </div>
            ...
            <div class="problems">
                <table class="problem-table">
                    ...
                    <tbody>
                        <tr>
                            <td></td>
                            <td><a href="https://vjudge.net/problem/Gym-287306H"> Welcome for you with Conditions </a></td>
                        ...
                        <tr>
                            <td></td>
                            <td><a href="https://vjudge.net/problem/Gym-287306J"> Max and Min </a></td>
