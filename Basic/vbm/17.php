    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="info-box">
                ...
                <p>This section provides information aboutDivisors
                    , including their importance and difficulty level.</p>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="resources">
                ...
                <div class="resource-item">
                    <div class="title"><a href="https://www.programiz.com/cpp-programming/examples/factors-number">1. C++ Program to Display Factors of a Number | Programiz</a></div>
                    <div class="title"><a href="https://www.youtube.com/watch?v=Ae_Ag_saG9s">2. L2. Print all Divisors of a Number | Maths Playlist | take U forward</a></div>
                    <div class="title"><a href="https://www.tutorialspoint.com/find-all-divisors-of-a-natural-number-set-2-in-cplusplus">3. Find all divisors of a natural number - Set 2 in C++ | tutorialspoint</a></div>
                </div>
            </div>
        </div>
            ...
            <div class="problems">
                <table class="problem-table">
                    ...
                    <tbody>
                        <tr>
                            <td></td>
                            <td><a href="https://vjudge.net/problem/Gym-405759K">1. Divisors</a></td>
